...
In this lab, HTTP traffic will be generated and captured using Wireshark. The captured traffic will then be analyzed to identify request methods, response codes, and protocol behavior relevant to SOC investigations.
